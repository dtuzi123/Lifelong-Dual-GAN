...
class LifeLone_MNIST(object):
    ...
    def Predict_DomainAccuracy(self,testX,testY):
    ...
    def test(self):
        ...
        with tf.Session(config=config) as sess:
            ...
            self.saver.restore(sess, 'models/TwoTeacherStudent_Unsupervised')
            ...
            mnistError = self.Predict_DomainAccuracy(self.mnist_test_x,self.mnist_test_y)
            fashionError = self.Predict_DomainAccuracy(self.FashionTest_x,self.FashionTest_y)
            svhnError = self.Predict_DomainAccuracy(self.svhn_test_x,self.svhn_test_y)
            IFashionError = self.Predict_DomainAccuracy(self.InverseFashionTest_x,self.InverseFashionTest_y)
    ...
    def train(self):
        ...
        with tf.Session(config=config) as sess:
            ...
            self.saver.save(self.sess, "models/TwoTeacherStudent_Unsupervised")
